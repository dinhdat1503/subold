...
!(function (t, e) {
        ...
        Q = (t, e = "hide") => {
            ...
            F.on(document, i, `[data-bs-dismiss="${s}"]`, function (i) {
                if (
                    ...
                    return;
                const n =
                    V.getElementFromSelector(this) || this.closest(`.${s}`);
    ...
    class Nt extends R {
        ...
        _addEventListeners() {
            this._config.keyboard &&
                F.on(this._element, vt, (t) => this._keydown(t)),
    ...
    class Ze extends R {
        ...
        show(t) {
            this._isShown ||
                ...
                F.trigger(this._element, Be, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
    ...
    class pi extends R {
        ...
        show(t) {
            this._isShown ||
                F.trigger(this._element, ai, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                this._backdrop.show(),
    ...
    class Fi extends R {
        ...
        _isAnimated() {
            return (
                ...
                (this.tip && this.tip.classList.contains($i))
            );
        }
        _isShown() {
                ...
                if ("click" === e)
                    F.on(
                        ...
                        (t) => {
                            ...
                            (e._activeTrigger[Pi] = !(
                                e._isShown() && e._activeTrigger[Pi]
                            )),
                                e.toggle();
                        }
                    );
