...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document
        ...
        .setAttribute(
            "data-pc-preset",
            localStorage.getItem("preset_change") ?? "preset-6"
        );
    document
        .getElementsByTagName("body")[0]
        .setAttribute(
            "data-pc-theme",
            localStorage.getItem("data-pc-theme") ?? "light"
        );
    document
        .getElementsByTagName("body")[0]
        .setAttribute(
            "data-pc-sidebar-caption",
            localStorage.getItem("data-pc-sidebar-caption") ?? true
        );
    document
        .getElementsByTagName("body")[0]
        .setAttribute(
            "data-pc-theme_contrast",
            localStorage.getItem("data-pc-theme_contrast") ?? true
        );
    change_box_container(
        localStorage.getItem("data-pc-box-container") ?? false
    );
    ...
    if (mobile_collapse_over) {
        mobile_collapse_over.addEventListener("click", function () {
            if (
                !document
                    .querySelector("body")
                    .classList.contains("pc-horizontal")
            ) {
                // menu_click();
            }
...
function layout_sidebar_change(value) {
    if (value == "true") {
        ...
        localStorage.setItem("data-pc-theme_contrast", "true");
        ...
        localStorage.setItem("data-pc-theme_contrast", "");
...
function layout_caption_change(value) {
    if (value == "true") {
        ...
        localStorage.setItem("data-pc-sidebar-caption", "true");
        ...
        localStorage.setItem("data-pc-sidebar-caption", "false");
...
function preset_change(value) {
    ...
    localStorage.setItem("preset_change", value);
    ...
    if (layout == "dark") {
        ...
        if (control) {
            document
                ...
                .classList.remove("active");
            document
                .querySelector(".theme-layout .btn[data-value='dark']")
                .classList.add("active");
        }
        ...
        if (control) {
            document
                ...
                .classList.remove("active");
            document
                .querySelector(".theme-layout .btn[data-value='light']")
                .classList.add("active");
        }
    }
}
function change_box_container(value) {
    if (document.querySelector(".pc-content")) {
        if (value == "true") {
            ...
            localStorage.setItem("data-pc-box-container", value);
        } else {
